        ...
        children: [
          ...
          Row(
            ...
            children: [
              Padding(
                padding: EdgeInsets.symmetric(horizontal: 40),
                child: TextLabel(false, false, false, true, false, 'Tạo Tài Khoản', 25, false, 0),
              )
            ],
          ),
          SizedBox(height: 20),
          Row(
            ...
            children: [
              Container(
                ...
                padding: EdgeInsets.symmetric(horizontal: 40),
                child: TextLabel(false, false, false, false, true, 'Hãy đăng ký để trở thành một phần của Ombee chúng tôi đi nào!', 16, false, 0),
              )
            ],
          ),
          SizedBox(height: 25),
          ...
          SizedBox(height: 35),
          Button(0, 0, 'Đăng ký', CustomColor(), () => print("123")),
          SizedBox(height: 25),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 40),
            child: Column(
              children: [
                TextLabel(false, false, false, false, true, "Bấm vào đây để đọc các điều luật", 16, false, 1),
                GestureDetector(
                  onTap: () => print("123"),
                  child: TextLabel(false, false, true, false, false, "Bắt đầu thôi", 16, false, 1),
                )
              ]
            ),
          )
