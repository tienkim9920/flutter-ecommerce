...
class Checkout extends StatelessWidget {
  ...
  const Checkout(this.currentParent, this.backStep, this.checkoutItem, this.gotoCheckingOrder,
    this.modalCheckout, this.onChangeModal, { Key? key }) : super(key: key);
            ...
            child: Column(
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 40),
                            child: TextLabel(false, false, false, true, false, checkoutItem.addressState, 16, false, 0),
                          )
                        ],
                      ),
                      SizedBox(height: 5),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      TextLabel(false, false, false, true, false, 'Tổng đơn hàng: ', 20, true, 0),
                      TextLabel(true, false, false, true, false, '70000', 20, true, 0),
                    ],
                  ),
                ),
                SizedBox(height: 40),
                Button(0, 0, 'Tiến hành đặt hàng', CustomColor(), () => onChangeModal())
              ]
            ),
          ),
          if (modalCheckout) ...[
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        TextLabel(false, false, false, true, false, "Bạn đã đặt hàng thành công", 24, false, 1),
                        SizedBox(height: 30),
                        ButtonCustom('Kiểm tra đơn hàng', () => gotoCheckingOrder(checkoutItem))
                      ],
                    ),
                  ),
                ],
